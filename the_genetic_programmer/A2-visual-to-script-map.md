...
Companion to `A2-sprint-review-script.md` (~4:34 at 128 wpm). Cells are named by the banner comment on their
...
* **Pacing buffer.** Script runs 4:11–4:53 across 140–120 wpm. At the slow end
  that is seven seconds of margin, so do not ad-lib. The three prompts are
